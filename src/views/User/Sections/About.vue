              ...
              <div class="row mt-2">
                <div class="col-12">
                  <h4 class="mb-1">
                    : الدولة
                    <img
                      :src="`https://flagcdn.com/24x18/${user_about.country.toLowerCase()}.png`"
                      ...
                      width="24"
                      height="18"
                      :alt="countries[user_about.country]"
                      v-if="user_about.country"
                    />
                  </h4>
              ...
              <div class="row mt-2" v-if="social_media">
                ...
                <div class="col-4">
                  <a :href="social_media.twitter" target="_blank"
                    ><img
                      src="@/assets/images/icon/social/twitter_off.png"
                      alt="twitter"
                      class="w-100"
                  /></a>
                </div>
                <div class="col-4">
                  <a :href="social_media.instagram" target="_blank"
                    ><img
                      src="@/assets/images/icon/social/instagram.png"
                      alt="instagram"
                      class="w-100"
                  /></a>
                </div>
            ...
            <div class="row mt-2">
              <div class="col-12">
                <h4 class="mb-1">
                  : الكاتب المفضل
                  <img
                    src="@/assets/images/icon/auther.png"
                    alt="fav auther"
                    width="25"
                  />
                </h4>
            ...
            <div class="row mt-2">
              <div class="col-12">
                <h4 class="mb-1">
                  : الاقتباس المفضل
                  <img
                    src="@/assets/images/icon/quotes.png"
                    alt="fav quotes"
                    width="25"
                  />
                </h4>
            ...
            <div class="row mt-2">
              <div class="col-12">
                <h4 class="mb-1">
                  : القسم المفضل
                  <img
                    src="@/assets/images/icon/section.png"
                    alt="fav section"
                    width="25"
                  />
                </h4>
