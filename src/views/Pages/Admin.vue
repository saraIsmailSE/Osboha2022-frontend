    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card card-block card-stretch card-height">
                ...
                <div class="card-body">
                    <apexchart height="100%" type="line" :options="account.options" :series="account.series"/>
                </div>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="flex-wrap d-flex align-items-center justify-content-between">
                        ...
                        <apexchart height="200" type="radialBar" class="col-md-8 col-lg-8" :options="adminChart.options" :series="adminChart.series"/>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <b-progress class="shadow-none w-100 mt-2" style="height: 6px">
                            <b-progress-bar :value="95" variant="warning"></b-progress-bar>
                        </b-progress>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body text-center">
                    <apexchart width="290" type="pie" :options="adminChart1.options" :series="adminChart1.series"/>
