...
export default {
  ...
  methods: {
   ...
   async getBook(id){
        this.bookToUpdate = await api.get(`books/${id}`);
        this.form.name = this.bookToUpdate.data.data.name;
        this.form.author = this.bookToUpdate.data.data.writer;
        this.form.publisher = this.bookToUpdate.data.data.publisher;
        this.form.link = this.bookToUpdate.data.data.link;
        this.form.start_page = this.bookToUpdate.data.data.start_page;
        this.form.end_page = this.bookToUpdate.data.data.end_page;
        this.form.level = this.bookToUpdate.data.data.level;
        this.form.section = this.bookToUpdate.data.data.section; 
        this.form.type = this.bookToUpdate.data.data.type;
        this.form.brief = this.bookToUpdate.data.data.brief;
        this.form.language =  this.bookToUpdate.data.data.language;
    },
    async onSubmit() {
      this.v$.$touch();
