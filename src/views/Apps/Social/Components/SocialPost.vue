      ...
      <div class="card card-block card-stretch card-height">
         <div class="card-body">
            <div class="user-post-data">
               <div class="d-flex justify-content-between">
                  ...
                  <div class="w-100">
                     <div class="d-flex justify-content-between">
                        <div class="">
                           <h5 class="mb-0 d-inline-block">{{ post.author }}</h5>
            ...
            <div class="comment-area mt-3">
               ...
               <hr>
      <SocialComment v-if="post.comments" :no_comments="false" :comments="post.comments" />
            <SocialComment v-else :no_comments="true" />         
...
<script>
import SocialComment from '../Components/SocialComment.vue'
export default {
   name: 'SocialPost',
   components:{
      SocialComment
