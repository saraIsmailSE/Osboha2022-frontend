      ...
      <iq-card>
        ...
        <template v-slot:body>
          <ul class="media-story m-0 p-0">
            <li v-for="(book, index) in books" :key="index" class="d-flex align-items-center active">
              <img src="@/assets/images/main/book.png" alt="story-img" class="rounded-circle img-fluid" />
          ...
          <router-link :to="{ name: 'osboha.book' }">
            <button class="btn btn-primary d-block mt-3 w-100">مشاهدة الكل</button>
          </router-link>
        </template>
      </iq-card>
