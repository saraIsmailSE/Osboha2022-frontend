      ...
      <div class="row no-gutters">
        ...
        <div class="col-sm-6 bg-white pt-5">
                    <div class="sign-in-from">
                        ...
                        <p>أدخل البريد الالكتروني وكلمة المرور</p>
                        <form class="mt-4" @submit.prevent="submit">
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control mb-0" id="exampleInputEmail1"
                                    placeholder="البريد الالكتروني" v-model="v$.form.email.$model">
                                <p class="error" v-if="!v$.form.email.required">الرجاء قم بادخال البريد الالكتروني</p>
                            </div>
                            <div class="form-group">
                                <label class="form-label" for="exampleInputPassword1">كلمة المرور</label>
                                <router-link :to="{ name: 'auth.recoverpassword1' }" class="float-end">نسيت كلمة المرور؟
                                </router-link>
                                <input type="password" class="form-control mb-0" id="exampleInputPassword1"
                                    placeholder="كلمة المرور" v-model="v$.form.password.$model">
                                <p class="error" v-if="!v$.form.email.required">الرجاء قم بادخال كلمة السر</p>
                            </div>
                            <div class="d-inline-block w-100">
                                <div class="form-check d-inline-block mt-2 pt-1">
                                    <input type="checkbox" class="form-check-input" id="customCheck11">
                                    <label class="form-check-label" for="customCheck11">تذكرني</label>
                                </div>
                            ...
                            <div class="sign-info">
                                <span class="dark-color d-inline-block line-height-2">لا تملك حساب؟<router-link
                                        :to="{ name: 'auth.sign-up1' }"> تسجيل جديد</router-link></span>
