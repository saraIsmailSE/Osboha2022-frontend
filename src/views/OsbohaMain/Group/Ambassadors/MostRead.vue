    ...
    <iq-card>
      <template v-slot:body>
        <div class="iq-todo-right">
          <div
            class="iq-todo-friendlist mt-3"
            v-if="most_read && most_read.length > 0"
          >
            <ul class="suggestions-lists m-0 p-0">
              <li
                class="d-flex mb-4 align-items-center"
                v-for="(record, index) in most_read.slice(0, 2)"
                :key="index"
              >
            ...
            <div
              class="container mt-3 mb-3 d-flex align-items-center justify-content-center"
              hight="200px"
            >
              <Bar
                id="my-chart-id"
