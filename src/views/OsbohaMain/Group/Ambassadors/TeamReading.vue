<template>
  <div class="row" v-if="group_users > 0">
    ...
    <div class="col-lg-9">
      <AmbassadorsAchievement v-if="ambassadorsAchievementList" :ambassadorsAchievementList="ambassadorsAchievementList"
        :group_id="group.id" :group_name="group.name" :group_users="group_users" :most_read="most_read" />
    </div>
  </div>
