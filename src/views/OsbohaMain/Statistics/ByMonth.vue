        ...
        <template v-slot:body>
            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-sm-12"
                            v-for="(topPages, index) in response.max_total_pages.slice(0, 3) " :key="topPages.user.id">
                            <NewTopUserFrame :userID="topPages.user.id" :userName="topPages.user.name"
                                ...
                                :topNumber="index" :image='`most_read_in_month_${index + 1}.png`'/>
                        </div>
                        <div class="header-title">
                            <h3 class="ms-3 title">
                                50 أخرين
                ...
                <div class="card">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-sm-12"
                            v-for="(topTheses, index) in response.max_total_thesis.slice(0, 3) " :key="topTheses.user.id">
                            <NewTopUserFrame :userID="topTheses.user.id" :userName="topTheses.user.name"
                                ...
                                :topNumber="index" :image='`most_write_in_month_${index + 1}.png`'/>
                        </div>
                        <div class="header-title">
                            <h3 class="ms-3 title">
                                50 أخرين
