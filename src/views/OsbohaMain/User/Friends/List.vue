            ...
            <div class="d-flex justify-content-end flex-grow-1 ms-3">
              ...
              <div
                :class="`dropdown-menu dropdown-menu-right ${
                  controlList[index] ? 'show' : ''
                }`"
                aria-labelledby="dropdownMenuButton"
              >
                <router-link
                  :to="{ name: 'user.profile', params: { user_id: friend.id } }"
                >
                ...
                <a
                  class="dropdown-item d-flex align-items-center"
                  v-else-if="checkNotFriendsOfAuth(friend.id)"
                ...
                <a
                  class="dropdown-item d-flex align-items-center"
                  v-else-if="!checkFriendsOfAuth(friend.id)"
                  @click="createFriendship(friend.id)"
                >
                  <span class="material-symbols-outlined me-2 md-18">
                    group_add
          ...
          <iq-card class="iq-card">
            <div class="iq-card-body p-0">
              <div class="image-block text-center">
                <img
                  src="@/assets/images/main/no-friends.png"
