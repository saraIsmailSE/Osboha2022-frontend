        ...
        <iq-card class="iq-card">
            ...
            <div class="iq-card-body p-4">
                <div class="image-block text-center mt-3">
                    ...
                    <img v-else class="img-fluid rounded w-75" src="@/assets/images/main/reading_list.png"
                        alt="add-group" />
                </div>
            </div>
                ...
                <div class="sign-in-from">
                    <form class="mt-2" @submit.prevent="onSubmit()">
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" v-model="v$.bookForm.brief.$model" class="form-control mb-0"
                                id="bookDescription" placeholder="وصف الكتاب " :style="{
                                    'padding-right': '1rem !important',
                                }" style="direction: rtl; max-height: 120px; resize: none; overflow: auto" :rows="1"
                                ref="bodyRef" />
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" v-model="v$.bookForm.publisher.$model" class="form-control mb-0"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" v-model="v$.bookForm.start_page.$model" class="form-control mb-0"
                                id="bookStartPage" placeholder="صفحة البداية " />
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" v-model="v$.bookForm.end_page.$model" class="form-control mb-0"
                                id="bookEndPage" placeholder="صفحة النهاية " />
...
export default {
    ...
    methods: {
        ...
        uploadFile() {
            this.bookForm.book_media = this.$refs.book_media.files[0];
        },
