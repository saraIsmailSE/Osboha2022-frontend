            ...
            <div class="iq-card-body p-3">
                ...
                <ul class="mt-3 list-group" v-if="books.length > 0">
                    <li class="list-group-item d-flex justify-content-between align-items-center" v-for="book in books"
                        ...
                        <span class="rounded-pill badge bg-primary">{{ book.book.section.section }}</span>
                    </li>
                </ul>
...
export default {
    ...
    async created() {
        ...
        this.auth_id = user_data.user.id;
    ...
    computed: {
        isAuth() {
            ...
            return this.auth_id === parseInt(this.$route.params.user_id);
        },
    },
