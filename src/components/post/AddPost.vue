      ...
      <modal id="modals" dialogClass="modal-fullscreen-sm-down" tabindex="-1" title="Create Post"
        ...
        <model-body>
          ...
          <ul class="d-flex flex-wrap align-items-center list-inline m-0 p-0">
            ...
            <li class="col-md-6 mb-3">
              <div class="bg-soft-primary rounded p-2 pointer me-3"><a href="#"></a><img
                  src="../../assets/images/small/08.png" alt="icon" class="img-fluid"> اضافة استعلام</div>
            </li>
          </ul>
          <hr>

          <button class="btn btn-primary d-block w-100 mt-3" @click="addNewPost()">نشـــر</button>
        </model-body>
      </modal>
    </iq-card>
  </div>
