    ...
    <div class="row mt-2">
        ...
        <div class="col-12 d-flex mt-1" v-if="social_media.facebook">
            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="25"
                height="25" x="0" y="0" viewBox="0 0 112.196 112.196" style="enable-background:new 0 0 75 75"
                xml:space="preserve" class="align-middle me-1">
                <g>
                    <circle cx="56.098" cy="56.098" r="56.098" style="" fill="#3b5998" data-original="#3b5998" class="">
                    </circle>
                    <path
        ...
        <div class="col-12 d-flex mt-1" v-if="social_media.instagram">
            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="25"
                height="25" x="0" y="0" viewBox="0 0 551.034 551.034" style="enable-background:new 0 0 75 75"
                xml:space="preserve" class="align-middle me-1">
                <g>
        ...
        <div class="col-12 d-flex mt-1" v-if="social_media.whatsapp">
            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="25"
                height="25" x="0" y="0" viewBox="0 0 152 152" style="enable-background:new 0 0 25 25"
        ...
        <div class="col-12 d-flex mt-1" v-if="social_media.telegram">
            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="25"
                height="25" x="0" y="0" viewBox="0 0 24 24" style="enable-background:new 0 0 512 512"
                xml:space="preserve" class="align-middle me-2">
                <g>
