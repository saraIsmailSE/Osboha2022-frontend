<template>
    <div class="container">
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="container row d-flex justify-content-center m-auto">
                                ...
                                <div class="col-lg-1 col-md-1 col-sm-2 text-center">
                                    <span class="btn button-60 mr-2 mt-1">
                                        عربي
                                    </span>
                                </div>
                                <div class="col-lg-1 col-md-1 col-sm-2 text-center">
        ...
        <div class="row mb-3">
            <div class="col-4">
                <button class="button-53" role="button" style="background-color:#77d792">مضاف حديثًا</button>
            </div>
            <div class="col-4">
                <button class="button-53" role="button" style="background-color:#0a6681">الأكثر
                    قراءة</button>
            </div>
            <div class="col-4">
                <button class="button-53 animated-btn" role="button" style="background-color:#f9c93e; color: black;">اختر لي</button>
            </div>
