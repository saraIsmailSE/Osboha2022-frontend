        ...
        <div class="d-flex justify-content-between flex-wrap">
          ...
          <div class="dropdown w-100">
            <select
              ...
              v-model="monthAchievementFilter"
            >
...
export default {
  ...
  methods: {
    ...
    async userMonthAchievement() {
      try {
        const response = await Marks.userMonthAchievement(
          this.$route.params.user_id,
          this.monthAchievementFilter
        );
        ...
        if (e.response.data.statusCode == 404) {
          ...
          this.monthAchievementFilter = "current";
        }
      }
    },
  },
  computed: {
    formated_month_title() {
      ...
      return splited_title ? splited_title[splited_title.length - 1] : "";
    },
    line_data() {
      let data = {
