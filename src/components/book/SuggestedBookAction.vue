<template>
    <div class="text-center">
        ...
        <!-- <div class="border border-danger w-100 mt-2 mb-3 text-center p-3"
            v-if="isTeamCoordinator && suggestion.book.is_active">
...
export default {
    ...
    data() {
        return {
            actionForm: {
                suggestion_id: this.$route.params.suggestion_id,
                reviewer_note: "",
                status: '',
            },
            message: null,
            ...
            swalWithBootstrapButtons
                ...
                .then(async (result) => {
                    if (result.isConfirmed) {
                        this.removeMsg = await BookSuggestion.removeBookFromOsboha(this.suggestion.book.id);
                        helper.toggleToast(
