            ...
            <div class="card d-flex align-items-center mb-4">
              ...
              >
                <div class="carousel-inner w-75 m-4">
                  <div
                    class="carousel-item"
                    v-for="(book, index) in book_in_progress"
                    :key="index"
                  ...
                  >
                    <div class="progress mb-3">
                      <div
                        ...
                        aria-valuemin="0"
                        aria-valuemax="100"
                        :style="`width: ${Math.trunc(progress[index])}%;`"
                      ></div>
                    </div>
                ...
                >
                  <span
                    class="carousel-btn material-symbols-outlined carousel-control-prev-icon"
                    aria-hidden="true"
                  >
                    arrow_back_ios
                  </span>
                ...
                >
                  <span
                    class="carousel-btn material-symbols-outlined carousel-control-next-icon"
                    aria-hidden="true"
                  >
                    arrow_forward_ios
                  </span>
