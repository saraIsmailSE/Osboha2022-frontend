<template>
  ...
  <ul class="navbar-nav iq-main-menu" id="sidebar-menu" @click="toggleSidebar">
    ...
    <li class="nav-item">
      <router-link
        :class="
          checkActive('statistics.byWeek') ? 'active nav-link' : 'nav-link'
        "
        aria-current="page"
    ...
    <li class="nav-item">
      <router-link
        :class="checkActive('book.free-book') ? 'active nav-link' : 'nav-link'"
        aria-current="page"
        :to="{
          name: 'book.free-book',
          params: {
    ...
    <li class="nav-item" v-if="isAdmin || inBooksTeam">
      <router-link
        :class="checkActive('book.create') ? 'active nav-link' : 'nav-link'"
        aria-current="page"
        :to="{ name: 'book.create' }"
      >
    ...
    <li class="nav-item" v-if="isSupervisor">
      <router-link
        :class="
          checkActive('control.pending-theses') ? 'active nav-link' : 'nav-link'
        "
        aria-current="page"
        :to="{
    ...
    <template v-if="advisorAndAbove">
      ...
      <li class="nav-item last-element">
        <router-link
          :class="
            checkActive('control.groups') ? 'active nav-link' : 'nav-link'
          "
          aria-current="page"
          :to="{
            name: 'control.groups',
