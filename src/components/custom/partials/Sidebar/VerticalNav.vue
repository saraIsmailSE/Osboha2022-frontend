<template>
  ...
  <ul class="navbar-nav iq-main-menu" id="sidebar-menu" @click="toggleSidebar">
    ...
    <template v-if="leaderAndAbove">
      ...
      <li class="nav-item">
        <router-link :class="checkActive('general-conversion.index')
            ? 'active nav-link'
            : 'nav-link'
          " aria-current="page" :to="{
    name: 'general-conversion.index',
      ...
      <li class="nav-item" v-if="consultantAndAbove">
        <router-link :class="checkActive('general-conversion.statistics')
            ? 'active nav-link'
            : 'nav-link'
          " aria-current="page" :to="{
    name: 'general-conversion.statistics',
      ...
      <li class="nav-item" v-if="advisorAndAbove">
        <router-link :class="checkActive('general-conversion.workingHours')
            ? 'active nav-link'
            : 'nav-link'
          " aria-current="page" :to="{
    name: 'general-conversion.workingHours',
      ...
      <li class="nav-item" v-if="isAdmin">
        <router-link :class="checkActive('general-conversion.workingHoursStats')
            ? 'active nav-link'
            : 'nav-link'
          " aria-current="page" :to="{
